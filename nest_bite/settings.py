"""
Django settings for nest_bite project.
...
ALLOWED_HOSTS = ['8000-valerios05-nestbite-x0yb3k3gjuz.ws.codeinstitute-ide.net','.herokuapp.com']
...
WSGI_APPLICATION = 'nest_bite.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER') # Got from env (mail)
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD')  # Got from env (password)
